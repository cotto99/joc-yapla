    ...
    <div class="min-h-screen bg-gradient-to-br from-orange-50 via-white to-yellow-50">
        ...
        <div class="max-w-4xl mx-auto px-4 py-8">
            ...
            <div class="text-center mb-8">
                ...
                <h2 class="text-3xl font-black text-gray-800">Tu cotizacion esta lista!</h2>
                <p class="text-gray-500 mt-2">Aca te mostramos el costo total de traer tu producto a Guatemala</p>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-1">
                    <div class="bg-white rounded-2xl shadow p-5 sticky top-6">
                        ...
                        <div v-else class="w-full h-52 bg-orange-50 rounded-xl flex items-center justify-center mb-4">
                ...
                <div class="lg:col-span-2 space-y-4">
                    ...
                    <div class="bg-white rounded-2xl shadow p-6">
                        ...
                        <div class="space-y-3">
                            <div class="flex justify-between items-center py-3 border-b">
                                <div>
                                    ...
                                    <p class="text-xs text-gray-400">Precio en dolares</p>
                                </div>
                                <span class="font-mono font-bold text-gray-800 text-lg">{{ fmt(cotizacion.precio_usd, true) }}</span>
                            </div>
                            <div class="flex justify-between items-center py-3 border-b">
                                <div>
                            ...
                            <div class="flex justify-between items-center py-3 border-b">
                                <div>
                                    ...
                                    <p class="text-xs text-gray-400">Envio desde USA a Guatemala</p>
                                </div>
                                <span class="font-mono text-gray-700">{{ fmt(cotizacion.costo_flete) }}</span>
                            </div>
                            <div class="flex justify-between items-center py-3 border-b">
                                <div>
                                    <p class="font-medium text-gray-700">Impuestos de importacion</p>
                            ...
                            <div class="flex justify-between items-center py-3 border-b">
                                <div>
                                    <p class="font-medium text-gray-700">Comision del servicio</p>
                                    <p class="text-xs text-gray-400">Gestion y tramites de importacion</p>
                                </div>
                            ...
                            <div class="flex justify-between items-center py-3 border-b">
                                <div>
                                    ...
                                    <p class="text-xs text-gray-400">Envio a tu direccion</p>
                                </div>
                        ...
                        <div class="bg-gradient-to-r from-orange-500 to-yellow-500 rounded-xl p-5 mt-4 text-white">
                            <div class="flex justify-between items-center">
                                <div>
                                    <p class="text-orange-100 text-sm uppercase tracking-wide font-bold">Total puesto en Guatemala</p>
                    ...
                    <div class="bg-white rounded-2xl shadow p-6">
                        <div class="flex items-center gap-4 mb-5">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-400">El resto lo pagas al recibir tu producto</p>
                            </div>
                        </div>
                        ...
                        <div class="bg-blue-50 rounded-xl p-4 mb-5 flex items-center gap-3">
                            ...
                            <div>
                                <p class="text-xs text-blue-600 font-bold uppercase tracking-wide">Tiempo estimado de entrega</p>
                    ...
                    <!-- Pasos -->
                    <div class="bg-white rounded-2xl shadow p-6">
                        <h3 class="font-bold text-gray-700 mb-4">Como funciona?</h3>
                        <div class="space-y-3">
                            <div class="flex items-start gap-3">
                                ...
                                <div>
                                    <p class="font-medium text-gray-700 text-sm">Pagas el anticipo</p>
                                    <p class="text-xs text-gray-400">Transferis {{ fmt(cotizacion.anticipo_gtq) }} y subis el comprobante</p>
                                </div>
                            </div>
                            <div class="flex items-start gap-3">
                            ...
                            <div class="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-400">Nosotros hacemos todo el proceso de importacion</p>
                                </div>
                            </div>
                            <div class="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-400">En {{ cotizacion.tiempo_estimado }} en tu direccion</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div v-if="mostrarPedido"
            ...
            <div class="bg-white rounded-2xl shadow-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto">
                ...
                <!-- Header -->
                <div class="bg-gradient-to-r from-green-500 to-emerald-500 text-white p-5 rounded-t-2xl sticky top-0 z-10">
                ...
                <div class="p-5 space-y-4">
                    ...
                    <!-- Direccion -->
                    <div>
                        <label class="block text-sm text-gray-600 mb-1">Direccion de entrega *</label>
                    ...
                    <label class="flex items-start gap-3 p-4 border-2 rounded-xl cursor-pointer transition"
                           :class="formPedido.envio_gratis ? 'border-green-400 bg-green-50' : 'border-gray-200 hover:border-gray-300'">
                        <input type="checkbox"
                               v-model="formPedido.envio_gratis"
                               class="mt-0.5 w-5 h-5 accent-green-500 flex-shrink-0" />
                        <div>
                            <p class="font-bold text-gray-800 text-sm">
                                🎉 Eres de Puerto Barrios o Santo Tomas?
                            </p>
                            <p class="text-xs text-gray-500 mt-0.5">
                                El envio es <strong class="text-green-600">gratis</strong> para estas areas.
                                Marca esta casilla y te descontamos <strong>{{ fmt(cotizacion.costo_entrega) }}</strong>.
                            </p>
                        </div>
                    </label>

                    <!-- RESUMEN DINAMICO -->
                    <div class="bg-yellow-50 border border-yellow-200 rounded-xl p-4 text-sm space-y-2">
                        <div class="flex justify-between text-gray-600">
                            <span>Total del pedido:</span>
                            <span class="font-bold">{{ fmt(totalMostrado) }}</span>
                        </div>
                        <div v-if="formPedido.envio_gratis" class="flex justify-between text-green-600 text-xs">
                            <span>Descuento envio gratis (Barrios / Sto. Tomas):</span>
                            <span>- {{ fmt(cotizacion.costo_entrega) }}</span>
                        </div>
                        <div class="flex justify-between font-black text-base border-t border-yellow-300 pt-2">
                            <span>Anticipo a pagar ahora:</span>
                            <span class="text-yellow-600">{{ fmt(anticipoMostrado) }}</span>
                        </div>
                    </div>
                    ...
                    <div class="bg-yellow-50 border-2 border-yellow-300 rounded-xl p-4">
                        ...
                        <p class="text-sm text-yellow-700 mb-3">
                            Transfiere <strong>{{ fmt(anticipoMostrado) }}</strong> y sube la imagen del comprobante
                        </p>
